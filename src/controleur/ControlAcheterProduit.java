	...
	public String AcheterProduit(String produit, int numero, int quantite, String nomAcheteur) {
		...
		if (resultat == 0) {
			...
			chaine.append(nomAcheteur + " veut acheter " + quantite + " " + produit
					+ ", malheureusement " + nomVendeur + " n'en a plus que "+ resultat+".\n"+nomAcheteur+" achète tout le stocke de " + nomVendeur +"\n");
		} else {
			chaine.append(nomAcheteur+" achète "+resultat+" "+produit+" à "+ nomVendeur+ ".\n");
		}
		return chaine.toString();
	}
}
